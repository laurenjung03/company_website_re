    ...
    <div className="container mx-auto px-4 py-32 max-w-7xl">
      <div className="relative rounded-2xl overflow-hidden shadow-2xl mb-24">
        ...
        <div className="absolute bottom-8 left-8 md:bottom-12 md:left-12 text-white">
          <h3 className="text-2xl md:text-4xl font-bold mb-2">ABC Company</h3>
      ...
      <div className="mb-24 text-center max-w-4xl mx-auto">
        <h2 className="text-4xl font-bold mb-8 text-slate-800">비전</h2>
        <p className="text-2xl leading-relaxed text-gray-600 font-light">
          2030년까지 글로벌 시장을 선도하는 기술혁신 기업으로 도약하여 <br /> 더
          나은 세상을 만드는데 기여하겠습니다
        </p>
      </div>
      <div className="mb-24">
        <h2 className="text-4xl font-bold mg-12 text-slate-800 text-center">
          회사 연혁
        </h2>
          ...
          {[
            ...
            >
              <div className="w-1/2 text-center ">
                <div className="bg-white rounded-xl shadow-lg p-8 hover:shadow-xl border border-gray-100">
